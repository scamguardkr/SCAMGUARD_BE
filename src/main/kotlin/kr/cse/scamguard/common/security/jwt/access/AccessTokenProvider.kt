package kr.cse.scamguard.common.security.jwt.access
...
class AccessTokenProvider(
    ...
    @Value("\${jwt.access-token.expiration-time}") private val tokenExpiration: Duration
) : JwtProvider {
    ...
    override fun getJwtClaimsFromToken(token: String): JwtClaims {
        ...
        return AccessTokenClaim.of(
            claims.get(AccessTokenClaimKeys.USER_ID.value, String::class.java).toLong(),
            claims.get(AccessTokenClaimKeys.ROLE.value, String::class.java)
        )
    }
