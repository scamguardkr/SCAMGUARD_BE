...
@Component
class Llama3LLMProvider (
    @Qualifier("llama3ChatModel") private val chatModel: OpenAiChatModel,
    ...
    override fun analyzeScam(prompt: String): LlmScamAnalysisResult {
        ...
        try {
            ...
            log.error("DeepSeekLlm 분석 중 오류 발생 {}", e.message)
            throw RuntimeException("OpenAI 분석 실패", e)
        }
    }

    override fun getModelName(): String = "llama-3.1-405b-instruct:free"
