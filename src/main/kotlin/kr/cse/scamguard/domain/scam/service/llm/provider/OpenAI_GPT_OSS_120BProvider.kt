...
@Component
class OpenAI_GPT_OSS_120BProvider(
    @Qualifier("gptOss120BChatModel") private val chatModel: OpenAiChatModel,
    ...
    override fun analyzeScam(prompt: String): LlmScamAnalysisResult {
        ...
        try {
            ...
            log.debug("gpt-oss-120B 응답: {}", response)
    ...
    override fun getModelName(): String = "gpt-oss-120b:free"
